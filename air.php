        ...
        <form class="form-group"><!--form-->
            ...
            <div id="input"><!--input-->
                ...
                <select  id="input-group" style="background: black;">
                    ...
                    <option value="">Novoair</option>
                    <option value="">USBangla</option>
                    <option value="">Biman Bangladesh</option>
                </select>
                <select  id="input-group" style="background: black;">
                ...
                <div id="input4"><!--input4-->
                    <input type="text" id="input-group" placeholder="Return Date(dd.mm.yy)">
                    <input type="text" id="input-group" placeholder="Return time(dd.mm.yy)">
